(function () {
  ...
  angular
    .module('pmsJs')
    .controller('alltransLateformcontroller', alltransLateformcontroller);

  /** @ngInject */
  function alltransLateformcontroller($rootScope, $filter, alertify, $scope, $log, $state, cashin, payment, device, transactionTask, jQ) {
    var vm = this;
    vm.query = {};
    vm.chang_status;
    vm.size = 500;
    vm.loadingTrank = function (page) {
      ...
      //}
      vm.page = page;
      if (vm.query.srcbankcardinput)
        vm.query.srcbankcard = "[" + vm.query.srcbankcardinput + "]";
      else
        vm.query.srcbankcard = undefined;
